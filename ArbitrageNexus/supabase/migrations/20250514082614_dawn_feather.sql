/*
  ...
  1. Tables
    - exchange_api_keys: Stores encrypted exchange API credentials
    - api_key_audit_logs: Tracks API key usage and modifications
...
-- Create audit logs table with action constraint
